...
for i=1:number_quarters
    ...
    % Load data
    load(['0_',num2str(year(datetime(datestr(quarters_num(i))))),'Q',num2str(quarter(datetime(datestr(quarters_num(i))))),'.mat']);
    ...
    model.gdp_deflator_growth_ea_quarterly=gdp_deflator_growth_ea;
    model.real_gdp_ea_quarterly=real_gdp_ea;
    
    save(['../data/abm/',num2str(year(datetime(datestr(quarters_num(i))))),'Q',num2str(quarter(datetime(datestr(quarters_num(i))))),'.mat'],'model');    
end
